...
class ManageLevelInitial extends Command
{
    ...
    public function handle()
    {
        ...
        if ($answer == 'HellYeah') {
            ...
            $level = array(
                'management_title' => 'تیم توسعه',
                'english_management_title' => 'Development Team',
                'manager_title' => 'مدیر توسعه‌ی نرم‌افزار',
                'english_manager_title' => 'Development Team Manager',
                'level' => 0.0,
            );
