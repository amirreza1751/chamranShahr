...
@section('content')
    <div class="iran container-fluid" dir="rtl" style="padding: 50px;">
        <section class="content-header">
            <h1 class="iran-bold">
                اطلاعیه: <span> @if(isset($notice->title)) {{$notice->title}} @endif </span>
            </h1>
        </section>
        <div class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-sm-12">
                        <div class="card">
                            <img class="card-img-top" src="{{ $notice->path }}" alt="Card image"
                                 style="width:100%">
                            <div class="card-body">
                            </div>
                        </div>
                        ...
                        <div class="labelbox">
                            <div class="row">
                                <div class="col-sm-9 text-justify" style="padding-left: 5rem"><span> @if(isset($notice->description)) {{$notice->description}} @endif </span></div>
                            </div>
                        </div>
                    </div>
