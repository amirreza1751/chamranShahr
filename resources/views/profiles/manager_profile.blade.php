            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="{{ Auth::user()->avatar() }}"
                        ...
                        <a href="" class="btn btn-primary btn-block"><b>مشاهده‌ی صفحه‌ی عمومی</b></a>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
            ...
            <div class="col-md-8">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                        <li class="active"><a href="#notifications" data-toggle="tab" aria-expanded="false">نوتیفیکیشن‌ها</a></li>
